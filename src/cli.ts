...
function dispatchPlan(parsed: ParsedArgv, cwd: string): Promise<CommandResult> {
...
function dispatchInstall(parsed: ParsedArgv): Promise<CommandResult> {
