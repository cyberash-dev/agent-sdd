...
/*
 * CST-003 / INV-004 / CST-006 — minimal glob expander, duplicated from
 * features/lint to avoid a cross-slice import (no third-party glob library).
 */
