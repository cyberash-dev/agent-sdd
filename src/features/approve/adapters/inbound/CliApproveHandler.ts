...
import { writeAttestation, type WriteAttestationPorts } from "../../application/WriteAttestation.js";
...
export class CliApproveHandler implements ApproveCommand {
  ...
  private async executeInline(
    ...
    if (outcome.kind === "refused") return refusalResult(outcome.refusal, format);
